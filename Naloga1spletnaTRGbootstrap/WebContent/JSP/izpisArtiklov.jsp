		...
		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 col-sm-offset-4 col-lg-offset-4 col-md-offset-4">
			...
			<%
				...
				if (request.getParameter("izbrisi") != null)
					seznamArtiklov.izbrisi(request.getParameter("izbrisi"));
			%>
			<div class="row">
			...
			<table class="table">
				...
				<% for (Artikel a:seznamArtiklov.vrniVse()) { %>
					<tr>
						<td><%=a.getNaziv()%></td>
						<td><%=a.getCena()%>€</td>
						...
						<td>
							...
							<a href="izpisArtiklov.jsp?izbrisi=<%=URLEncoder.encode(a.getCrtnaKoda())%>"><button type="button" onclick="return confirm('Ste prepričani?');" class="btn btn-danger">Izbriši</button></a>
						</td>
					</tr>
				<% } %>
			</table>
